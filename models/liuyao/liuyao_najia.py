...
# 导入子模块
from .modules.location import location_service
from .modules.solar_time import solar_time_calculator
from .modules.yao_components import yao_components
from .modules.health_analyzer import health_analyzer
from .modules.gua_calculator import gua_calculator
...
class LiuYaoNaJia:
    ...
    def calculate_gua(self, solar_date: datetime.date, time_hour: float, 
        ...
        返回:
            Dict: 包含六爻卦象的相关信息
        """
        return gua_calculator.calculate_gua(
